...
public class StaggeredGridActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view=(RecyclerView) findViewById(R.id.staggered_view);
        ...
        adapter=new ViewAdapter(this, datas, R.layout.item_staggered, R.id.staggered_image, R.id.staggered_text, false);
